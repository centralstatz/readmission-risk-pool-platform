...
| Distribution of prebuilt synthetic inputs/products | Affects time-to-first-use and repository size | Resolved for inputs in Phase 3 and logical products in Iteration 6.1; physical products Iteration 6.2 | Do not distribute generated source/canonical data or Iteration 6.1 product materializations; authoritative operations rebuild inputs and keep logical products in memory |
...
| Product materialization versus query | Affects product adapters and freshness semantics | Logical boundary resolved in Iteration 6.1; physical choice Iteration 6.2 | Logical products/access are storage-independent and currently in memory; choose one replaceable physical reference adapter with the minimal app |
