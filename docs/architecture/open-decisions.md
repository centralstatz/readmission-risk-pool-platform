...
| Distribution of prebuilt synthetic inputs/products | Affects time-to-first-use and repository size | Resolved for inputs in Phase 3; revisit products in Phase 5 | Do not distribute generated source or canonical data; authoritative code/configuration reproduce both scales, while the small Phase 2 fixture remains the handoff teaching asset |
...
| Default logical product suite | Determines supplied app and compatibility surface | Phase 6 | Start narrow; old eight-product suite is evidence, not a requirement |
