...
| First provider runtime | Affects package/API scope | Iteration 4.2 | R package boundary now exists; provider specification, trust/selection, execution, and estimates remain unresolved |
