...
| First canonical clinical-domain capability profile | Determines actual required, conditional, optional, and unavailable clinical inputs | Phase 2.2 | Generic mechanics are resolved; the first domain set, keys, fields, and controlled vocabularies remain open |
