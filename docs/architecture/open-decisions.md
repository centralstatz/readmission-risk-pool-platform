...
| First provider runtime | Affects package/API scope | Resolved in Iteration 4.2 | `rrpruntime@0.2.0` validates declarations and compatibility, executes isolated registered adapters, validates outputs, and constructs structured results/estimates; the shipped transparent provider is nonclinical conformance software |
