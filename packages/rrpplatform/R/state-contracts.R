...
rrp_project_state_backup_contract_expected <- function() {
  c(
    "Record-Type" = "contract",
    ...
    "Manifest-File" = "backup.dcf",
    "Payload-File" = "history.duckdb",
...
rrp_state_backup_contract <- function(catalog) {
  rrp_project_contract_record(
    catalog, "rrp.contract.project-state-backup",
    rrp_project_state_backup_contract_expected(), "project_state_backup_contract"
  )
}
